  ...
  return (
    <div className="h-screen flex bg-background overflow-hidden">
      ...
      {activeType === "channel" && activeChannel ? (
        ...
        <ChatArea conversations={conversations} conversation={activeConversation} onCallStateChange={setActiveCallConversationId} onSelectConversation={(id) => { setActiveId(id); setActiveType("chat"); fetchConversations(); }} />
      )}
    </div>
  );
}
